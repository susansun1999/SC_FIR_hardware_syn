...
module fir4
               (
                ...
                product81, // sfix20_En18
                product97, // sfix20_En18
                product113, // sfix20_En18
                product129, // sfix20_En18
                product145, // sfix20_En18
                negproduct57, // sfix20_En18
                negproduct89, // sfix20_En18
                filter_out
                );
  ...
  input signed [19:0] product81; // sfix20_En18
  input signed [19:0] product97; // sfix20_En18
  input signed [19:0] product113; // sfix20_En18
  input signed [19:0] product129; // sfix20_En18
  input signed [19:0] product145; // sfix20_En18
  input signed [19:0] negproduct57; // sfix20_En18
  input signed [19:0] negproduct89; // sfix20_En18
...
////////////////////////////////////////////////////////////////
  ...
  reg  signed [27:0] delay_pipeline [0:143] ; // sfix28_En18
  wire signed [27:0] sumvector [0:143] ; // sfix28_En18

  wire signed [27:0] finalsum; // sfix28_En18
  wire signed [27:0] add_signext; // sfix28_En18
  wire signed [27:0] add_signext_1; // sfix28_En18
  wire signed [28:0] add_temp; // sfix29_En18
  wire signed [27:0] add_signext_2; // sfix28_En18
  wire signed [27:0] add_signext_3; // sfix28_En18
  wire signed [28:0] add_temp_1; // sfix29_En18
  wire signed [27:0] add_signext_4; // sfix28_En18
  wire signed [27:0] add_signext_5; // sfix28_En18
  wire signed [28:0] add_temp_2; // sfix29_En18
  wire signed [27:0] add_signext_6; // sfix28_En18
  wire signed [27:0] add_signext_7; // sfix28_En18
  wire signed [28:0] add_temp_3; // sfix29_En18
  wire signed [27:0] add_signext_8; // sfix28_En18
  wire signed [27:0] add_signext_9; // sfix28_En18
  wire signed [28:0] add_temp_4; // sfix29_En18
  wire signed [27:0] add_signext_10; // sfix28_En18
  wire signed [27:0] add_signext_11; // sfix28_En18
  wire signed [28:0] add_temp_5; // sfix29_En18
  wire signed [27:0] add_signext_12; // sfix28_En18
  wire signed [27:0] add_signext_13; // sfix28_En18
  wire signed [28:0] add_temp_6; // sfix29_En18
  wire signed [27:0] add_signext_14; // sfix28_En18
  wire signed [27:0] add_signext_15; // sfix28_En18
  wire signed [28:0] add_temp_7; // sfix29_En18
  wire signed [27:0] add_signext_16; // sfix28_En18
  wire signed [27:0] add_signext_17; // sfix28_En18
  wire signed [28:0] add_temp_8; // sfix29_En18
  wire signed [27:0] add_signext_18; // sfix28_En18
  wire signed [27:0] add_signext_19; // sfix28_En18
  wire signed [28:0] add_temp_9; // sfix29_En18
  wire signed [27:0] add_signext_20; // sfix28_En18
  wire signed [27:0] add_signext_21; // sfix28_En18
  wire signed [28:0] add_temp_10; // sfix29_En18
  wire signed [27:0] add_signext_22; // sfix28_En18
  wire signed [27:0] add_signext_23; // sfix28_En18
  wire signed [28:0] add_temp_11; // sfix29_En18
  wire signed [27:0] add_signext_24; // sfix28_En18
  wire signed [27:0] add_signext_25; // sfix28_En18
  wire signed [28:0] add_temp_12; // sfix29_En18
  wire signed [27:0] add_signext_26; // sfix28_En18
  wire signed [27:0] add_signext_27; // sfix28_En18
  ...
  assign add_signext = $signed({{8{product145[19]}}, product145});
  assign add_signext_1 = delay_pipeline[0];
  assign add_temp = add_signext + add_signext_1;
  assign finalsum = add_temp[27:0];
  ...
  assign add_signext_2 = $signed({{8{product129[19]}}, product129});
  assign add_signext_3 = delay_pipeline[16];
  assign add_temp_1 = add_signext_2 + add_signext_3;
  assign sumvector[15] = add_temp_1[27:0];
  ...
  assign add_signext_4 = $signed({{8{product113[19]}}, product113});
  assign add_signext_5 = delay_pipeline[32];
  assign add_temp_2 = add_signext_4 + add_signext_5;
  assign sumvector[31] = add_temp_2[27:0];
  ...
  assign add_signext_6 = $signed({{8{product145[19]}}, product145});
  assign add_signext_7 = delay_pipeline[40];
  assign add_temp_3 = add_signext_6 + add_signext_7;
  assign sumvector[39] = add_temp_3[27:0];
  ...
  assign add_signext_8 = $signed({{8{product97[19]}}, product97});
  assign add_signext_9 = delay_pipeline[48];
  assign add_temp_4 = add_signext_8 + add_signext_9;
  assign sumvector[47] = add_temp_4[27:0];
  ...
  assign add_signext_10 = $signed({{8{negproduct57[19]}}, negproduct57});
  assign add_signext_11 = delay_pipeline[56];
  assign add_temp_5 = add_signext_10 + add_signext_11;
  assign sumvector[55] = add_temp_5[27:0];
  ...
  assign add_signext_12 = $signed({{8{product81[19]}}, product81});
  assign add_signext_13 = delay_pipeline[64];
  assign add_temp_6 = add_signext_12 + add_signext_13;
  assign sumvector[63] = add_temp_6[27:0];
  ...
  assign add_signext_14 = $signed({{8{product73[19]}}, product73});
  assign add_signext_15 = delay_pipeline[72];
  assign add_temp_7 = add_signext_14 + add_signext_15;
  assign sumvector[71] = add_temp_7[27:0];
  ...
  assign add_signext_16 = $signed({{8{product81[19]}}, product81});
  assign add_signext_17 = delay_pipeline[80];
  assign add_temp_8 = add_signext_16 + add_signext_17;
  assign sumvector[79] = add_temp_8[27:0];
  ...
  assign add_signext_18 = $signed({{8{negproduct89[19]}}, negproduct89});
  assign add_signext_19 = delay_pipeline[88];
  assign add_temp_9 = add_signext_18 + add_signext_19;
  assign sumvector[87] = add_temp_9[27:0];
  ...
  assign add_signext_20 = $signed({{8{product97[19]}}, product97});
  assign add_signext_21 = delay_pipeline[96];
  assign add_temp_10 = add_signext_20 + add_signext_21;
  assign sumvector[95] = add_temp_10[27:0];
  ...
  assign add_signext_22 = $signed({{8{product145[19]}}, product145});
  assign add_signext_23 = delay_pipeline[104];
  assign add_temp_11 = add_signext_22 + add_signext_23;
  assign sumvector[103] = add_temp_11[27:0];
  ...
  assign add_signext_24 = $signed({{8{product113[19]}}, product113});
  assign add_signext_25 = delay_pipeline[112];
  assign add_temp_12 = add_signext_24 + add_signext_25;
  assign sumvector[111] = add_temp_12[27:0];
  ...
  assign add_signext_26 = $signed({{8{product129[19]}}, product129});
  assign add_signext_27 = delay_pipeline[128];
  assign add_temp_13 = add_signext_26 + add_signext_27;
  assign sumvector[127] = add_temp_13[27:0];
  ...
  assign sumvector[143] = $signed({{8{product145[19]}}, product145});
