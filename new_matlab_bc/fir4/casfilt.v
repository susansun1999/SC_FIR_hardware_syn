...
//
// Stage 4               : Direct-Form Symmetric FIR
// HDL Implementation    : Fully parallel
// Folding Factor        : 1
...
////////////////////////////////////////////////////////////////
  ...
  wire signed [9:0] filter_in_stage3; // sfix10_En9
  wire signed [9:0] filter_out_stage3; // sfix10_En9
  wire clk_enable_stage3; // boolean
  wire signed [9:0] filter_in_stage4; // sfix10_En9
  wire signed [9:0] filter_out_stage4; // sfix10_En9
  wire clk_enable_stage4; // boolean
  wire ce_out_stage4; // boolean
  wire signed [9:0] filter_in_stage2_tmp; // sfix10_En9
  wire signed [9:0] filter_in_stage3_tmp; // sfix10_En9
  wire signed [9:0] filter_in_stage4_tmp; // sfix10_En9
  reg  cedelay1_stage1; // boolean
  reg  cedelay1_stage4; // boolean
  ...
  casfilt_stage4 u_casfilt_stage4
    (
    .clk(clk),
    .clk_enable_stage4(clk_enable_stage4),
    .reset(reset),
    .filter_in_stage4(filter_in_stage4),
    .filter_out_stage4(filter_out_stage4)
    );
  ...
  assign filter_in_stage4_tmp = filter_out_stage3;

  assign filter_in_stage4 = filter_in_stage4_tmp;
  ...
  assign clk_enable_stage4 = ce_out_stage1;
  always @ (posedge clk or posedge reset)
    begin: cedelay_stage4_process
      if (reset == 1'b1) begin
        cedelay1_stage4 <= 1'b0;
      end
      else begin
        if (clk_enable_stage4 == 1'b1) begin
          cedelay1_stage4 <= logical_one;
        end
      end
    end // cedelay_stage4_process

  assign ce_out_stage4 =  clk_enable_stage4 & cedelay1_stage4;

  assign ce_out = ce_out_stage4;
  // Assignment Statements
  assign filter_out = filter_out_stage4;
endmodule  // casfilt
